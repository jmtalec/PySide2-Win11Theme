...
# Sheet: Where | is replaced by the accent color
sheet = """/*BACKGROUND*/
QWidget {
...
def Win11Layout(window):
    """ Set the windows 11 layout to PySide2 QWidget window """
    font = QFont()
    ...
    font.setWeight(50)
    window.setFont(font)
    qssSheet = sheet.replace('|', accent)
    window.setStyleSheet(qssSheet)
